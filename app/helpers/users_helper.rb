module UsersHelper
  ...
  def users_evolution_graph(game_ids, users)
    ...
    chart.width = 960
    chart.height = 400
    chart.colors = %w( #FF0000 #FF1493 #FF7F50 #FFD700 #483D8B #ADFF2F #32CD32 #006400 #808000 #008080 #00FFFF #7FFFD4 #4682B4 #0000FF #000080 #000000 #800000 #D2691E #F4A460 #808080 #2F4F4F )
