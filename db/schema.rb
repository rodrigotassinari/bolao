...
ActiveRecord::Schema.define(:version => 20100609023535) do
  ...
  add_index "users", ["payment_code"], :name => "index_users_on_payment_code", :unique => true
  add_index "users", ["payment_transaction_code"], :name => "index_users_on_payment_transaction_code"
